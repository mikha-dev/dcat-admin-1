...
use Dcat\Admin\Enums\TabContentType;
use Illuminate\Contracts\Support\Renderable;

//todo:: tab vertical tabs
class TabAdv extends Widget {

	/**
	 * @var string
	 */
	protected $view = 'admin::widgets.tab-adv';
	 ...
	 * @return $this
	 */
	public function add( string $title, string|Renderable $content, ?string $id = null, bool $active = FALSE, ?string $icon = null, ?string $badge = null ): static {
    ...
    public function addLink(string $title, string $href, bool $active = false, ?string $icon = null, ?string $badge = null) : static
    {
        $id = (string)mt_rand();
        $count = count($this->tabs);
