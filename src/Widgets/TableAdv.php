...
class TableAdv implements Renderable
{
    protected string $view = 'admin::widgets.table-adv';
...
//    protected int $depth = 0;
    ...
    public function headerClass(?StyleClassType $class) : static
    {
        if($class)
    ...
    public function withHover() : static
    {
        $this->withHover = true;
